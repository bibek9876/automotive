...
export default function Carousel({ items }) {
  ...
  return (
    <section
      ...
      className="relative h-[190vh] border-b border-[var(--color-divider)]"
    >
      <div className="sticky top-[81px] overflow-hidden pt-2">
        <div className="section-shell pt-8 pb-7 sm:pt-10 sm:pb-8">
          <div className="max-w-3xl">
            ...
            <h2 id="workshop-view-heading" className="section-heading mt-4 text-[var(--color-ink)]">
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="p-3.5 sm:p-4">
                ...
                <h3 className="mt-1.5 text-[1.12rem] leading-[1.08] font-semibold tracking-[-0.035em] text-[var(--color-ink)] sm:text-[1.24rem]">
                  {item.title}
                </h3>
                <p className="mt-2 max-w-sm text-[0.92rem] leading-5.5 text-[var(--color-ink-soft)]">
                  {item.caption}
                </p>
              </div>
            </article>
